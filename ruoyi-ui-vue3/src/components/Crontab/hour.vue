    ...
    <el-form>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :value="2">
                ...
                <el-input-number v-model='cycle02' :min="cycle01 + 1" :max="23" /> {{ $tp("时") }}
            </el-radio>
        </el-form-item>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :value="3">
                {{ $tp("从") }}
                <el-input-number v-model='average01' :min="0" :max="22" /> {{ $tp("时开始，每") }}
                <el-input-number v-model='average02' :min="1" :max="23 - average01" /> {{ $tp("小时执行一次") }}
            </el-radio>
        </el-form-item>
